    ...
    var hot_html_cells_data = [
        {
            ...
            title: "<a href='http://themeforest.net/item/ReadyWorX-responsive-web-application-kit/13080328' target='_blank'>ReadyWorX - Responsive Web Application Kit</a>",
            description: "ReadyWorX is one of the best application templates ever built. Very flexible and clean admin template based on Bootstrap and Less. Available in 4 different layouts.",
