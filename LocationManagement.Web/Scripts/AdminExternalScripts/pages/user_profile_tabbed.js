...
$(function() {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            // Init
            var sales = ec.init(document.getElementById('sales'), ReadyWorX);
            var visits = ec.init(document.getElementById('visits'), ReadyWorX);
            var plans = ec.init(document.getElementById('plans'), ReadyWorX);
