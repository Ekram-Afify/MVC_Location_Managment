...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var basic_scatter = ec.init(document.getElementById('basic_scatter'), ReadyWorX);
            var bubble_size = ec.init(document.getElementById('bubble_size'), ReadyWorX);
            var large_scale = ec.init(document.getElementById('large_scale'), ReadyWorX);
            var scale_roaming = ec.init(document.getElementById('scale_roaming'), ReadyWorX);
            var category_scatter = ec.init(document.getElementById('category_scatter'), ReadyWorX);
            var time_data = ec.init(document.getElementById('time_data'), ReadyWorX);
            var timeline_scatter = ec.init(document.getElementById('timeline_scatter'), ReadyWorX);
