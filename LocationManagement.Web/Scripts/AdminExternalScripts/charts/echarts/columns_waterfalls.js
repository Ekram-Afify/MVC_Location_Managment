...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var basic_columns = ec.init(document.getElementById('basic_columns'), ReadyWorX);
            var stacked_columns = ec.init(document.getElementById('stacked_columns'), ReadyWorX);
            var stacked_clustered_columns = ec.init(document.getElementById('stacked_clustered_columns'), ReadyWorX);
            var thermometer_columns = ec.init(document.getElementById('thermometer_columns'), ReadyWorX);
            var compositive_waterfall = ec.init(document.getElementById('compositive_waterfall'), ReadyWorX);
            var change_waterfall = ec.init(document.getElementById('change_waterfall'), ReadyWorX);
            var columns_timeline = ec.init(document.getElementById('columns_timeline'), ReadyWorX);
