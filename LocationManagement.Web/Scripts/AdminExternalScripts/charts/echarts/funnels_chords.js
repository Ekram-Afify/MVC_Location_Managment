...
$(function () {
    ...
    require(
        ...
        // Charts setup
        function (ec, ReadyWorX) {


            // Initialize charts
            // ------------------------------

            var funnel_asc = ec.init(document.getElementById('funnel_asc'), ReadyWorX);
            var funnel_desc = ec.init(document.getElementById('funnel_desc'), ReadyWorX);
            var funnel_left = ec.init(document.getElementById('funnel_left'), ReadyWorX);
            var funnel_right = ec.init(document.getElementById('funnel_right'), ReadyWorX);
            var funnel_multiple_overlay = ec.init(document.getElementById('funnel_multiple_overlay'), ReadyWorX);
            var funnel_multiple_separate = ec.init(document.getElementById('funnel_multiple_separate'), ReadyWorX);

            var chord_basic = ec.init(document.getElementById('chord_basic'), ReadyWorX);
            var chord_sorting = ec.init(document.getElementById('chord_sorting'), ReadyWorX);
            var chord_non_ribbon = ec.init(document.getElementById('chord_non_ribbon'), ReadyWorX);
            var chord_scale = ec.init(document.getElementById('chord_scale'), ReadyWorX);
