...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var line_bar = ec.init(document.getElementById('line_bar'), ReadyWorX);
            var column_pie = ec.init(document.getElementById('column_pie'), ReadyWorX);
            var scatter_pie = ec.init(document.getElementById('scatter_pie'), ReadyWorX);
            var scatter_line = ec.init(document.getElementById('scatter_line'), ReadyWorX);

            var connect_pie = ec.init(document.getElementById('connect_pie'), ReadyWorX);
            var connect_column = ec.init(document.getElementById('connect_column'), ReadyWorX);

            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), ReadyWorX);
