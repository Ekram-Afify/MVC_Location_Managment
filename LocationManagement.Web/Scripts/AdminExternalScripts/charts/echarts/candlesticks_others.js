...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var candlestick_basic = ec.init(document.getElementById('candlestick_basic'), ReadyWorX);
            var candlestick_line = ec.init(document.getElementById('candlestick_line'), ReadyWorX);
            var candlestick_scatter = ec.init(document.getElementById('candlestick_scatter'), ReadyWorX);

            var radar_basic = ec.init(document.getElementById('radar_basic'), ReadyWorX);
            var radar_filled = ec.init(document.getElementById('radar_filled'), ReadyWorX);

            var gauge_basic = ec.init(document.getElementById('gauge_basic'), ReadyWorX);
            var gauge_styling = ec.init(document.getElementById('gauge_styling'), ReadyWorX);
