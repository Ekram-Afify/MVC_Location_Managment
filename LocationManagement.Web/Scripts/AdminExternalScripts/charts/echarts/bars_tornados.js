...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var basic_bars = ec.init(document.getElementById('basic_bars'), ReadyWorX);
            var stacked_bars = ec.init(document.getElementById('stacked_bars'), ReadyWorX);
            var stacked_clustered_bars = ec.init(document.getElementById('stacked_clustered_bars'), ReadyWorX);
            var floating_bars = ec.init(document.getElementById('floating_bars'), ReadyWorX);
            var irregular_bars = ec.init(document.getElementById('irregular_bars'), ReadyWorX);
            var tornado_bars_negative = ec.init(document.getElementById('tornado_bars_negative'), ReadyWorX);
            var tornado_bars_staggered = ec.init(document.getElementById('tornado_bars_staggered'), ReadyWorX);
