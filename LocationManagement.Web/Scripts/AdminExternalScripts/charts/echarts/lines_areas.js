...
$(function() {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var basic_lines = ec.init(document.getElementById('basic_lines'), ReadyWorX);
            var stacked_lines = ec.init(document.getElementById('stacked_lines'), ReadyWorX);
            var inverted_axes = ec.init(document.getElementById('inverted_axes'), ReadyWorX);
            var line_point = ec.init(document.getElementById('line_point'), ReadyWorX);
            var basic_area = ec.init(document.getElementById('basic_area'), ReadyWorX);
            var stacked_area = ec.init(document.getElementById('stacked_area'), ReadyWorX);
            var reversed_value = ec.init(document.getElementById('reversed_value'), ReadyWorX);
