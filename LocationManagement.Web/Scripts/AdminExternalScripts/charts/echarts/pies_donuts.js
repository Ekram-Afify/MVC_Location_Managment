...
$(function () {
    ...
    require(
        ...
        function (ec, ReadyWorX) {
            ...
            var basic_pie = ec.init(document.getElementById('basic_pie'), ReadyWorX);
            var basic_donut = ec.init(document.getElementById('basic_donut'), ReadyWorX);
            var nested_pie = ec.init(document.getElementById('nested_pie'), ReadyWorX);
            var infographic_donut = ec.init(document.getElementById('infographic_donut'), ReadyWorX);
            var rose_diagram_hidden = ec.init(document.getElementById('rose_diagram_hidden'), ReadyWorX);
            var rose_diagram_visible = ec.init(document.getElementById('rose_diagram_visible'), ReadyWorX);
            var lasagna_donut = ec.init(document.getElementById('lasagna_donut'), ReadyWorX);
            var pie_timeline = ec.init(document.getElementById('pie_timeline'), ReadyWorX);
            var multiple_donuts = ec.init(document.getElementById('multiple_donuts'), ReadyWorX);
